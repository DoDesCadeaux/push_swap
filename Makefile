...
NAME	= push_swap
CC 		= gcc
CFLAGS	= -Wall -Wextra -Werror # -Imlx POUR MINILIBX
DFLAGS	=
# COMPIL	= -lmlx -framework OpenGL -framework AppKit # SERT UNIQUEMENT POUR MINILIBX
AUTHOR	= dduraku
DATE	= 11/04/2022
...
$(NAME):	${OBJS} ${OBJ_MAIN}
			...
			@$(call run_and_test,$(CC) $(CFLAGS) -I$(INCLUDE_PATH) -o $@ ${COMPIL} ${OBJS} ${OBJ_MAIN}) # ${COMPIL} SERT QUE POUR MINILIBX
